...
export const LLM_MODELS = [
  ...
  { id: "qwen2.5-7b-instruct", name: "Qwen 2.5 (7B)", size: "4.7 GB", speed: "Medium", logo: "/qwen.png", url: "https://huggingface.co/bartowski/Qwen2.5-7B-Instruct-GGUF/resolve/main/Qwen2.5-7B-Instruct-Q4_K_M.gguf", notes: ["Powerful multilingual capabilities", "Requires high spec PC (16GB+ RAM)", "Top tier open weights model"] },
